...
void main() {
  ...
  testWidgets('drags feed photo frame and message composer upward as one page', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
    ...
    final composerFinder = find.byKey(const ValueKey('fake-message-composer'));
...
Widget _fakeComposerBuilder(CameraCheckinFeedItem item) => const Text(
      'Message composer',
      key: ValueKey('fake-message-composer'),
    );
