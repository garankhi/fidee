          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                ...const <(String, String)>[
                  ...
                  return FilterChip(
                    label: Text(option.$2),
                    selected: _categories.contains(option.$1),
            ...
            Wrap(
              ...
              children: [
                FilterChip(
                  label: const Text('Tất cả'),
                  selected: _priceRanges.isEmpty,
                  onSelected: (_) => setState(_priceRanges.clear),
                ),
                ...const <(String, String)>[
                  ('*-50000', 'Dưới 50k'),
                  ('50000-100000', '50k–100k'),
                  ...
                  return FilterChip(
                    label: Text(option.$2),
                    selected: _priceRanges.contains(option.$1),
                    onSelected: (selected) => setState(() {
                      selected
            ...
            Wrap(
              ...
              children: [
                FilterChip(
                  label: const Text('Tất cả'),
                  selected: _disRanges.isEmpty,
                  onSelected: (_) => setState(_disRanges.clear),
                ),
                ...const <(String, String)>[
                  ('*-1000', 'Dưới 1 km'),
                  ('1000-3000', '1–3 km'),
                  ...
                  return FilterChip(
                    label: Text(option.$2),
                    selected: _disRanges.contains(option.$1),
                    onSelected: (selected) => setState(() {
                      selected
            ...
            Wrap(
              ...
              children: [
                FilterChip(
                  label: const Text('Tất cả'),
                  selected: _sortOptions.isEmpty,
                  onSelected: (_) => setState(_sortOptions.clear),
                ),
                ...const <(String, String)>[
                  ('distance', 'Gần nhất'),
                  ('rating', 'Đánh giá cao'),
                  ...
                  return FilterChip(
                    label: Text(option.$2),
                    selected: _sortOptions.contains(option.$1),
                    onSelected: (selected) => setState(() {
                      if (selected) {
