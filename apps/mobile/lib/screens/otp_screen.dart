...
class _OtpScreenState extends State<OtpScreen> {
  ...
  Future<void> _verifyOtp() async {
    final code = _otpCode;
    if (code.length != 6) {
      setState(() => _errorMessage = 'Vui long nhap du 6 so');
      return;
    }
    ...
    final result = await widget.authService.verifyOtp(code);
    ...
    if (result.success) {
      ...
      setState(() => _errorMessage = result.errorMessage ?? 'Ma OTP khong dung');
  ...
  Future<void> _resendOtp() async {
    ...
    final result = await widget.authService.resendOtp();
