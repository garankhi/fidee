    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          ...
          style: const TextStyle(color: Colors.white, fontFamily: 'SF Pro', height: 1.5),
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
          ...
          ElevatedButton(
            ...
            child: const Text('Mở Cài đặt', style: TextStyle(color: Colors.white, fontFamily: 'SF Pro', fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Row(
          children: [
            ...
            Text(
              'Tín hiệu GPS yếu',
              style: TextStyle(color: Colors.amber, fontFamily: 'SF Pro', fontWeight: FontWeight.bold),
            ),
          ],
        ),
        content: const Text(
        ...
        actions: [
          ElevatedButton(
            ...
            child: const Text('Đã hiểu', style: TextStyle(color: Colors.black, fontFamily: 'SF Pro', fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: const Text('Thử lại', style: TextStyle(color: Colors.white, fontFamily: 'SF Pro', fontWeight: FontWeight.bold)),
          ),
        ],
      ),
    );
