...
- Riêng `dart format`: nếu chạy lâu bất thường hoặc timeout nhiều lần trong môi trường agent, không cần tiếp tục retry; báo rõ tình trạng và để user chạy tay bên ngoài terminal nếu cần.
